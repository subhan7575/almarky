  ...
  return (
    <aside className="w-full md:w-64 bg-white border-r border-slate-100 p-6 space-y-8 sticky top-0 md:h-screen z-40">
      <div className="flex items-center px-2">
        <div className="w-10 h-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center overflow-hidden mr-3 shadow-lg shadow-slate-100">
          <AlmarkyVectorLogo className="w-8 h-8" />
        </div>
        <div>
